...
namespace MusicApp
{
    ...
    public sealed partial class ApplicationLayout : Page
    {
        ...
        private void MusicApp_ItemInvoked(NavigationView sender, NavigationViewItemInvokedEventArgs args)
        {
            MusicApp.IsBackEnabled = true;
            MusicApp.IsBackButtonVisible = NavigationViewBackButtonVisible.Visible;
            ...
            {
                case "home":
                    ContentPage.Navigate(typeof(Pages.HomePage), args.RecommendedNavigationTransitionInfo);
                    break;
                case "createSong":
        ...
        private void MusicApp_BackRequested(NavigationView sender, NavigationViewBackRequestedEventArgs args)
        {
